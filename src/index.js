const VueHapticSurface = {
  install(Vue, options) {
    Vue.component("haptic-surface", {
      template: `<div v-on="$listeners" @mousemove="sense" @click="sense"><slot></slot></div>`,
      props: {
...
export default VueHapticSurface
